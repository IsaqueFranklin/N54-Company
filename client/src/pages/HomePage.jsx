...
export default function HomePage(){
        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="text-center pb-12 md:pb-16">
            ...
            <div className="max-w-3xl mx-auto">
              <p className="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Nós trabalhamos para aumentar o alcance da sua empresa na internet.</p>
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-lg text-gray-600">Transforme sua presença online com a nossa expertise em marketing digital.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            {/* 1st item */}
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Estratégia digital</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Marketing de resultados</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Plataformas de negócios</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Tráfego pago</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Desenvolvimento web</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl border border-gray-300">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Consultoria estratégica</h4>
              <p className="text-gray-600 text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
    ...
    <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <img className="w-full hidden dark:block rounded-xl" src="https://images.unsplash.com/photo-1541746972996-4e0b0f43e02a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="dashboard image" />
        <div className="mt-4 md:mt-0">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Comece agora a dar vida ao seu negócio na internet.</h2>
            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">Usamos toda nossa expertise e conhecimento técnico para dar a luz à uma estratégia de marketing personalizada para colocar seu negócio na internet e começar a usar o poder dos anúncios online e das redes sociais para aumentar seu faturamento.</p>
            <a href="#" className="inline-flex items-center text-primary-800 bg-white hover:bg-gray-900 hover:text-white focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900">
                Quero crecer meu negócio
